...
if ( ! function_exists('gmt_to_local'))
{
	function gmt_to_local($time = '', $timezone = 'UTC', $dst = FALSE)
	{
		...
		$time += timezones($timezone) * 3600;
                ...
                /*
                 * daylight savings in uk is last sunday of march till last sunday of october
                 * it is written below as first sunday of april minus 1 week and first sunday november minus 1 week.
                 *
                 * This will need to be moved from here as it is UK specific
                 */
