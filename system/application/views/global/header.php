...
<link rel='stylesheet' href='<?=base_url()?>css/custom-theme/jquery-ui-1.8.1.custom.css' type='text/css' />

<script src="<?=base_url()?>js/jquery-1.4.2.min.js" type="text/javascript"></script>
<script src="<?=base_url()?>js/jquery-ui-1.8.1.custom.min.js" type="text/javascript"></script>
