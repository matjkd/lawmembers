...
<br/>
<?=$this->load->view('filetransfer/files_table')?>

<br/>
Note: The following bugs are known and are being looked into:<br/> 
1. After finishing uploading the page is supposed to 
refresh so you can see the files in the table. Occasionally this doesn't happen, so you need to refresh the page
yourself.  <br/>
2. If the page appears to have frozen, or stops responding, check you don't have a browse folder still open somewhere. Refresh the page.
